...
export const ENTITLEMENTS_SOURCE_PATH =
  ...
  "/sitecore/content/british-council/british-council/Data/Entitlements";
...
export const OPERATORS_SOURCE_PATH =
  ...
  "/sitecore/content/british-council/british-council/Data/Operators";

export const ROLES_FIELD_NAME = "Roles";
export const ROLES_SOURCE_PATH =
  process.env.NEXT_PUBLIC_ROLES_SOURCE_PATH ||
  "/sitecore/content/british-council/british-council/Data/Roles";
